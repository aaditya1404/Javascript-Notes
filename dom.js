...
// agar hmlog ko html ke andar ek element ko create karna rehta hai to hmlog 
// document.createElement(""); ka use karte hai
// createElement("yahan v koi v element lekh sakhte hai jaese ki li span h1 span any html element")
...
// appendChild() :-
// iska use hmlog ek element me ek value or ek aur element ko add karne ke liye use karte hai 
// jaese ki let span =  document.createElement("span");
// li.appendChild(span);
...
// tagName():-
// iska use hmlog ka DOM me kon sa tag hai usko janne ke liye karte hai jaese ki maan lo hmlog ek click function lagaye hai list me aur uska andar ek list yani ki li element hai.
// to agar hmlog lekhe ki list.target.tagName === "LI"  to isse agar li ke upar click hoga tabhi hmlog ka onClick fucntion kaam karega
...
// parentElement :- 
// ye jo v apna element hota hai uska parent element ko select karne ke kaam ata hai
// remove() - ye function help karta hai parentElement ko remove karne me